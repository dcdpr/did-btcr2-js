...
export default [
  {
    ...
    'components' : {
      ...
      'version'      : 1,
      'network'      : 'bitcoin',
      'genesisBytes' : Canonicalization.fromHex('02cb42563b126085e1fea427331583bd69ed87057ea9524a6221272469c8d4c000')
    }
  },
  {
  ...
  },
  {
    ...
    'components' : {
      ...
      'version'      : 1,
      'network'      : 'bitcoin',
      'genesisBytes' : Canonicalization.fromHex('be0db3aeee89da24d50112af74f40c6a27f84fd3ef1a280647f5448f4daf11b1')
    }
  },
  {
