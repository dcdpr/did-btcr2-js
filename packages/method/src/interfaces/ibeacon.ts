import { DidUpdatePayload, KeyBytes, UnixTimestamp } from '@did-btcr2/common';
...
export interface IBeacon {
     ...
     */
    broadcastSignal(didUpdatePayload: DidUpdatePayload, secretKey: KeyBytes): Promise<SignalsMetadata>;
}
