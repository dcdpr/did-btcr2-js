...
<<<<<<<< HEAD:packages/method/src/core/beacon/aggregate/protocol/nostr.ts
...
>>>>>>>> 336422f (add messages; continue coordinator):packages/method/src/btc1/beacon/aggregate/communication/nostr.ts
